    ...
    <div id="unsigned-waivers-container" class="collapse">
        <?php foreach($unsigned_waivers as $waiver): ?>
           <div class="alert alert-danger">
                <strong>Action Required!</strong><br/>Please click the button below in order to review and sign the agreements <?php echo $waiver->TITLE; ?>
						<br/><br/>
                        <p class="text-right">
                            <button type="button" class="btn btn-success tsp_ajax_tab" tsp_boot_tab="waiver-sign" tsp_waiver_id="<?php echo $waiver->ID; ?>">Review & Sign</button>
                        </p>
            </div>
        <?php endforeach; ?>
    </div>
