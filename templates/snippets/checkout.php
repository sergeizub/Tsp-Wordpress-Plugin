...
<div class="row">
		<div class="col-md-10 pt25">
			...
			<input type="hidden" name="convenience_fee_percent" value="<?php echo TSP_CONVENIENCE_FEE_PERCENT; ?>">
		    <input type="hidden" name="convenience_fee_amount" value="<?php echo TSP_CONVENIENCE_FEE_AMOUNT; ?>">   
		    <input type="hidden" name="convenience_fee_for_check" value="<?php echo TSP_CONVENIENCE_FEE_FOR_CHECK; ?>">
